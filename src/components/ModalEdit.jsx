...
//                 </h3>
//                 <button type="button"
//                     onClick={onClose} class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
//                     data-modal-toggle="crud-modal">
...
//                                     <select id="category" name={index} class=" bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500
...
//                             ) : (
//                                 <>
//                                     <label for="name" class=" block texxt-sm font-medium text-gray-900 dark:text-white capitalize mb-3 ">{index}</label>
//                                     <input type={item.type} name={index} value={dataDetail.name} class=" bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500
//                                                 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 " onChange={handleInputChange}/>
//                                 </>
//                             )
//                         }
//                     </div>
